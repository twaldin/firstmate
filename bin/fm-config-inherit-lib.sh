...
# for that home's crewmates too, and primary config/backlog-backend=manual makes
# that home hand-edit backlog files too). It also pushes the one primary-authoritative
...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness crew-codex-mcp backlog-backend}"
